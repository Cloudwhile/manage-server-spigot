...
public class PlayerListener implements Listener {
    ...
    public PlayerListener(ManageServer plugin, OneBotManager oneBotManager) {
        this.plugin = plugin;
    ...
    public void onPlayerJoin(PlayerJoinEvent event) {
        ...
        if (config.getBoolean("features.welcome-message", true)) {
            ...
            if (oneBotManager != null && oneBotManager.isEnabled()) {
                oneBotManager.sendPlayerJoinMessage(player.getName(), isFirstJoin);
            }
        }
    }
    ...
    public void onPlayerQuit(PlayerQuitEvent event) {
        ...
        if (config.getBoolean("features.quit-message", true)) {
            ...
            // 发送消息到QQ
            if (oneBotManager != null && oneBotManager.isEnabled()) {
                oneBotManager.sendPlayerQuitMessage(player.getName());
            }
        }
    }
